class ApplicationController < ActionController::Base
  ...
  helper_method :current_company, :current_store, :available_stores, :default_sale_list, :event_description_list

  rescue_from CanCan::AccessDenied do |exception|
    redirect_to root_url, alert: exception.message
  end

  def event_description_list
    @event_descriptions = EventDescription.order(:description)
  end

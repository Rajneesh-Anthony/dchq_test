class Customer < ActiveRecord::Base
  ...
  attr_accessible :address_attributes, :avatar_attributes, :certification_level_memberships_attributes,
                  ...
                  :send_event_related_emails, :tax_id, :zero_tax_rate, :booked, :deleted_at, :abn, :company_name
  ...
  def self.field_names
    { customer_experience_level_id: I18n.t("activerecord.attributes.customer.customer_experience_level_id"),
      ...
      abn:                          I18n.t("activerecord.attributes.customer.abn"),
      company_name:                 I18n.t("activerecord.attributes.customer.company_name"),
